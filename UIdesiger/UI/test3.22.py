...
class MainWindow(QMainWindow):
    ...
    def start_execution(self):
        ...
        parser.add_argument('pcd', default=r"mmdetection3d-master\test\kitti_000008.bin", help='Point cloud file')
        parser.add_argument('config', default=r"mmdetection3d-master\test\hv_second_secfpn_6x8_80e_kitti-3d-car.py", help='Config file')
        parser.add_argument('checkpoint', default=r"mmdetection3d-master\test\hv_second_secfpn_6x8_80e_kitti-3d-car_20200620_230238-393f000c.pth", help='Checkpoint file')
        parser.add_argument(
